...
function getSinglePluginResult(root, options) {
    return __awaiter(this, void 0, void 0, function* () {
...
function getMultiPluginResult(root, options, targetFiles) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const targetFile of targetFiles) {
            ...
            optionsClone.packageManager = detect_1.detectPackageManagerFromFile(optionsClone.file);
            try {
                const inspectRes = yield getSinglePluginResult(root, optionsClone);
                ...
                const customScannedProject = resultWithScannedProjects.scannedProjects.map((a) => {
                    a.targetFile = optionsClone.file;
                    a.packageManager =
...
function getDepsFromPlugin(root, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (options.allProjects) {
            ...
            const targetFiles = yield find_files_1.find(root, [], detect_2.AUTO_DETECTABLE_FILES, 1);
            debug(`auto detect manifest files, found ${targetFiles.length}`, targetFiles);
            if (targetFiles.length === 0) {
                throw errors_1.NoSupportedManifestsFoundError([root]);
            }
            inspectRes = yield getMultiPluginResult(root, options, targetFiles);
            return inspectRes;
        }
        else {
            ...
            inspectRes = yield getSinglePluginResult(root, options);
        }
        if (!cli_interface_1.legacyPlugin.isMultiResult(inspectRes)) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            for (const scannedProject of deps.scannedProjects) {
                ...
                const packageManager = project.packageManager || (deps.plugin && deps.plugin.packageManager);
                if (packageManager) {
