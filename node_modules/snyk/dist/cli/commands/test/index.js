...
function test(...args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const pinningSupported = pipResults &&
            (yield feature_flags_1.isFeatureFlagSupportedForOrg('pythonPinningAdvice', config.org)).ok;
...
function metaForDisplay(res, options) {
    ...
    if (targetFile) {
        meta.push(chalk_1.default.bold(rightPadWithSpaces('Target file: ', padToLength)) + targetFile);
    }
    if (res.projectName) {
